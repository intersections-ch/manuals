...
`sbx login` opens a browser for Docker. `claude` asks how you want to authenticate — pick your <mark>subscription</mark> (Pro or Max), not an API key. `/exit` when you're signed in.
