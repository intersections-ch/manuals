...
> **Requires:** Docker · **Sprache:** [Deutsch](n8n-docker.de.md)

Self-hosted automation platform. You'll run it in a container and log in at http://localhost:5678.

We use the course stack at [intersections-ch/docker-n8n-ollama-qdrant](https://github.com/intersections-ch/docker-n8n-ollama-qdrant) — n8n, Qdrant and Ollama as three separate compose files on one shared Docker network.
...
Ollama is a >3 GB image and takes a while. `-f` goes **before** the subcommand.
...
<!-- #TODO decide whether participants also create the Anthropic credential here or in the MCP manual. -->
